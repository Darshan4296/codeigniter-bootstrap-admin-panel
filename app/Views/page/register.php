                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h4><a href="<?php echo site_url('page/index'); ?>">view</a></h4>
                            </div>
                            <form class="user" method="post" action="<?php echo base_url('page/store'); ?>">
                            <?php csrf_field();  ?>
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo site_url('/page/login') ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
